...
const guests = [ 'Abby Valencia', 'Arvin Ranara', 'Bryan Ranara', 'Eloisa Madronio', 'Ernesto Ranara', 'Florentina Ranara', 'Francis Madronio', 'Janice Hernandez', 'Jasmin Hernandez',
                            ...
                            'Jaime Balbada', 'Janelle Judan', 'Jaynie Rose Judan', 'Jhielou Orofino', 'Jonalyn Judan', 'Marilou Sevidal', 'Severino Blanco', 'Shirley Balbada',
                            ...
                            'Mark Angelo Boquiron', 'Jysrael Gonato', 'Russel Anne Rodriguez', 'Tricia Rodriguez', 'Daniel Bryan Dela Cruz' ];
